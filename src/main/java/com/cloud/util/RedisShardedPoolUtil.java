...
public class RedisShardedPoolUtil {
    ...
    public static Long expire(String key,int exTime){
        ...
        Long result = null;
        try {
            jedis = com.cloud.common.RedisShardedPool.getJedis();
            result = jedis.expire(key,exTime);
        } catch (Exception e) {
            log.error("expire key:{} error",key,e);
            com.cloud.common.RedisShardedPool.returnBrokenResource(jedis);
            return result;
        }
        com.cloud.common.RedisShardedPool.returnResource(jedis);
        return result;
    }
